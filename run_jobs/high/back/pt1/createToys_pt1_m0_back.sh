...
echo "$LSB_JOBINDEX    start">>$LS_SUBCWD/../../../log/high/pt1_m0_back_log.txt
...
./execute $LSB_JOBINDEX 1 1 0 0

date

cp -R histograms1/* /afs/cern.ch/work/r/rkopecna/high/0_1/histograms1/

echo "$LSB_JOBINDEX    end">>$LS_SUBCWD/../../../log/high/pt1_m0_back_log.txt
