...
echo "$LSB_JOBINDEX    start">>$LS_SUBCWD/../../../log/high/pt2_m0_back_log.txt
...
./execute $LSB_JOBINDEX 1 2 0 0

date

cp -R histograms2/* /afs/cern.ch/work/r/rkopecna/high/0_1/histograms2/

echo "$LSB_JOBINDEX    end">>$LS_SUBCWD/../../../log/high/pt2_m0_back_log.txt
