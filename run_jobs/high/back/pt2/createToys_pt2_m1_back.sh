...
echo "$LSB_JOBINDEX    start">>$LS_SUBCWD/../../../log/high/pt2_m1_back_log.txt
...
./execute $LSB_JOBINDEX 1 2 1 0

date

cp -R histograms2/* /afs/cern.ch/work/r/rkopecna/high/1_2/histograms2/

echo "$LSB_JOBINDEX    end">>$LS_SUBCWD/../../../log/high/pt2_m1_back_log.txt
