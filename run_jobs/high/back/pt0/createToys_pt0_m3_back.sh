...
echo "$LSB_JOBINDEX    start">>$LS_SUBCWD/../../../log/high/pt0_m3_back_log.txt
...
./execute $LSB_JOBINDEX 1 0 3 0

date

cp -R histograms0/* /afs/cern.ch/work/r/rkopecna/high/3_4/histograms0/

echo "$LSB_JOBINDEX    end">>$LS_SUBCWD/../../../log/high/pt0_m3_back_log.txt
