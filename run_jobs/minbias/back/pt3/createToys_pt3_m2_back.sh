...
echo "$LSB_JOBINDEX    start">>$LS_SUBCWD/../../../log/minbias/pt3_m2_back_log.txt
...
./execute $LSB_JOBINDEX 0 3 2 0

date

cp -R histograms3/* /afs/cern.ch/work/r/rkopecna/minbias/30_60/histograms3/

echo "$LSB_JOBINDEX    end">>$LS_SUBCWD/../../../log/minbias/pt3_m2_back_log.txt
