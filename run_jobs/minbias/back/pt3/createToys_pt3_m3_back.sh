...
echo "$LSB_JOBINDEX    start">>$LS_SUBCWD/../../../log/minbias/pt3_m3_back_log.txt
...
./execute $LSB_JOBINDEX 0 3 3 0

date

cp -R histograms3/* /afs/cern.ch/work/r/rkopecna/minbias/60_100/histograms3/

echo "$LSB_JOBINDEX    end">>$LS_SUBCWD/../../../log/minbias/pt3_m3_back_log.txt
