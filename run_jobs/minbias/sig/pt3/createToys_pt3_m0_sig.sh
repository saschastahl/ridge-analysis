...
echo "$LSB_JOBINDEX    start">>$LS_SUBCWD/../../../log/minbias/pt3_m0_sig_log.txt
...
./execute $LSB_JOBINDEX 0 3 0 1

date

cp -R histograms3/* /afs/cern.ch/work/r/rkopecna/minbias/0_5/histograms3/

echo "$LSB_JOBINDEX    end">>$LS_SUBCWD/../../../log/minbias/pt3_m0_sig_log.txt
