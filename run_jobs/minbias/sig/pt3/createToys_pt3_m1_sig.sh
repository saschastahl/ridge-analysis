...
echo "$LSB_JOBINDEX    start">>$LS_SUBCWD/../../../log/minbias/pt3_m1_sig_log.txt
...
./execute $LSB_JOBINDEX 0 3 1 1

date

cp -R histograms3/* /afs/cern.ch/work/r/rkopecna/minbias/5_30/histograms3/

echo "$LSB_JOBINDEX    end">>$LS_SUBCWD/../../../log/minbias/pt3_m1_sig_log.txt
