...
echo "$LSB_JOBINDEX    start">>$LS_SUBCWD/../../../log/minbias/pt0_m1_sig_log.txt
...
./execute $LSB_JOBINDEX 0 0 1 1

date

cp -R histograms0/* /afs/cern.ch/work/r/rkopecna/minbias/5_30/histograms0/

echo "$LSB_JOBINDEX    end">>$LS_SUBCWD/../../../log/minbias/pt0_m1_sig_log.txt
