...
echo "$LSB_JOBINDEX    start">>$LS_SUBCWD/../../../log/minbias/pt2_m0_sig_log.txt
...
./execute $LSB_JOBINDEX 0 2 0 1

date

cp -R histograms2/* /afs/cern.ch/work/r/rkopecna/minbias/0_5/histograms2/

echo "$LSB_JOBINDEX    end">>$LS_SUBCWD/../../../log/minbias/pt2_m0_sig_log.txt
