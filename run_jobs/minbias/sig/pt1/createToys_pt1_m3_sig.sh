...
echo "$LSB_JOBINDEX    start">>$LS_SUBCWD/../../../log/minbias/pt1_m3_sig_log.txt
...
./execute $LSB_JOBINDEX 0 1 3 1

date

cp -R histograms1/* /afs/cern.ch/work/r/rkopecna/minbias/60_100/histograms1/

echo "$LSB_JOBINDEX    end">>$LS_SUBCWD/../../../log/minbias/pt1_m3_sig_log.txt
